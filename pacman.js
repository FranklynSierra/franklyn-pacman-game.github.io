...
//detectar colisiones entre el jugador y el fantasma
...
alert('perdiste ,dale reiniciar a la pagina')
   }
 }
}
...
//ganar
if(pellets.length===0){
  alert('ganaste, dale reiniciar a la pagina para volver a jugar')
  cancelAnimationFrame(animationId)
}
...
powerUp.draw()
//cuando el jugador toca el power up
 if(
    Math.hypot(
   ...
   powerUps.splice(i,1)
  //hacer que los fantasmas mueran 
...
//eliminar puntos y agregar puntuacion
